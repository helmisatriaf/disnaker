            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align:center;vertical-align:middle;font-size:10;">
                  <a href=`delete.php?no=<?php echo $row['id']; ?>` class=" m-1 text-align-center vertical-align-middle ">Delete</a>
                  <a href=`edit.php?no=<?php echo $row['id']; ?>` class=" m-5 text-align-center vertical-align-middle">Edit</a>
                </td>
              </tr>
